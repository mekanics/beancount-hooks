...
_STOPWORDS: Final[frozenset[str]] = frozenset({
    ...
    "einem", "einen", "und", "für", "mit", "von", "zu", "bei", "nach", "aus",
    "an", "in", "auf", "über", "unter", "vor", "hinter", "zwischen", "durch",
    "wegen", "trotz", "während", "bis", "seit", "ohne", "gegen", "um", "als",
    "wie", "so", "auch", "noch", "nur", "schon", "immer", "nie", "manchmal",
    "oft", "selten", "hier", "dort", "da", "dann", "wann", "warum", "wo",
    "wer", "was", "wie", "wieso", "weshalb", "weshalb",
    # English
    "the", "a", "an", "and", "for", "with", "of", "to", "at", "from", "by",
    "in", "on", "over", "under", "before", "after", "between", "through",
    "because", "during", "until", "since", "without", "against", "about",
    "as", "like", "so", "too", "very", "just", "only", "even", "still",
    "already", "always", "never", "sometimes", "often", "here", "there",
    "then", "when", "why", "where", "who", "what", "how",
    # French
    "le", "la", "les", "un", "une", "des", "du", "de", "et", "pour", "avec",
    "par", "sur", "sous", "dans", "en", "à", "au", "aux", "chez", "entre",
    "sans", "contre", "vers", "pendant", "depuis", "jusque", "ainsi", "aussi",
    "trop", "très", "juste", "seulement", "encore", "déjà", "toujours",
    "jamais", "souvent", "ici", "là", "alors", "quand", "pourquoi", "où",
