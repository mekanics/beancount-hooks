...
_STOPWORDS: Final[frozenset[str]] = frozenset({
    ...
    "wer", "was", "wieso", "weshalb",
    # English
    "the", "a", "and", "for", "with", "of", "to", "at", "from", "by",
    "on", "over", "under", "before", "after", "between", "through",
    "because", "during", "until", "since", "without", "against", "about",
    "as", "like", "too", "very", "just", "only", "even", "still",
    "already", "always", "never", "sometimes", "often", "here", "there",
    "then", "when", "why", "where", "who", "what", "how",
    # French
    "le", "la", "les", "un", "une", "du", "de", "et", "pour", "avec",
